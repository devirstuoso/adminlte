...
$arrow = <<< SVG
<svg xmlns="http://www.w3.org/2000/svg" style="position:absolute; color:white">
...
<section>
  <div style="background: #aa8d6f; " class="mrg" >
    <a href="<?php echo Url::to(['secretariat']); ?>" class="unlink"><h3  class="clear secr unlink">Meet the IoE Secretariat<?php echo '    '.$arrow?></h3></a>
  </div>
</section>
