...
<div class="school-obj-form">
    <div class="card card-purple">
        <div class="card-header">
            <h3 class="card-title">School's Objective & Vision</h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                <label for="schools-school_id" class="col-sm-3 col-form-label">Section Content</label>
                <div class="col-sm-8">
