...
<div class="school-office-index">
   ...
   <?= GridView::widget([
    ...
    'columns' => [
        ...
        'filter' => Html::activeDropDownList($searchModel, 'school_id', ArrayHelper::map(Schools::find()->asArray()->all(), 'school_id', 'school_name'), ['class' => 'form-control', 'prompt' => 'Select School'])
        ],
        'name',
         ['attribute' => 'position',
        'value' =>    function($model){
