        ...
        <div class="u-form u-form-1">
          <form action="#" method="POST" class="u-clearfix u-form-spacing-13 u-form-vertical u-inner-form" style="padding: 0;" source="custom" name="form">
            <div class="u-form-group u-form-name">
              ...
              <input type="text" placeholder="Enter your Name" id="name-f18c" name="name" class="u-grey-5 u-input u-input-rectangle u-input-1" required="" autofocus="autofocus">
            </div>
            <div class="u-form-group u-form-phone u-form-group-2">
              <label for="phone-cbff" class="u-label" wfd-invisible="true">Phone</label>
            ...
            <div class="u-form-email u-form-group u-form-group-3">
              <label for="email-adca" class="u-label">Email Id</label>
              <input type="email" placeholder="Enter a valid email address" id="email-adca" name="email" class="u-grey-5 u-input u-input-rectangle u-input-3" required="">
            </div>
            <div class="u-form-group u-form-message u-form-group-4">
              <label for="message-1015" class="u-label">Message</label>
              <textarea placeholder="Enter your message" rows="4" cols="50" id="message-1015" name="message-1" class="u-grey-5 u-input u-input-rectangle u-input-4" required=""></textarea>
            </div>
